...
conn = ibm_db.connect("DATABASE=bludb;HOSTNAME=125f9f61-9715-46f9-9399-c8177b21803b.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud;PORT=30426;SECURITY=SSL;SSLServerCertificate=DigiCertGlobalRootCA.crt;UID=znj04989;PWD=jx4y1L8EPH8E2FUs",'','')
...
def mailtest_registration(to_email):
    ...
    send.sendEmail('Plasma Donor Application', 'You are successfully registered as a user', to_email)
